...
\vskip-.3cm
\begin{equation}
    \boldsymbol{\sigma} \cdot \mathbf{n} = \boldsymbol{\sigma}_N \hspace{0.2cm} \text{on } \partial\Omega_N \text{.} 
\end{equation}
...
\begin{equation} \label{eq:strong2}
    \begin{cases}
        ...
        \boldsymbol{\sigma} \cdot \mathbf{n} = \boldsymbol{\sigma}_N \hspace{0.2cm} \text{on } \partial\Omega_N
    \end{cases}
\end{equation}
...
\begin{equation} \label{eq:primal-displacement}
    \sum_{\Omega_e \in \mathcal{T}} \int_{\Omega_e} \boldsymbol{\varepsilon}(\mathbf{u}) : \mathcal{D} : \boldsymbol{\varepsilon}(\mathbf{v}) d\Omega_e = \sum_{\Omega_e \in \mathcal{T}} \left(\int_{\Omega_e} \mathbf{v} \cdot \mathbf{b} d\Omega_e + \int_{\Gamma_N} \mathbf{v} \cdot \boldsymbol{\sigma}_N \;d\partial\Omega_e \right)
\end{equation}
